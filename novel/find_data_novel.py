...
index = 0
# 找前i個page
novels=["驚悚樂園","詭秘之主","大奉打更人","鬥破蒼穹","仙逆","琥珀之劍","全職高手","修真聊天群"]
for i in range(60):
    index += 1
    #搜尋的電影名字
    search_name = "破蒼穹"
    #url = "https://www.ptt.cc/bbs/movie/search?page="+str(index)+"&q="+quote(search_name)
    url = "https://www.ptt.cc/bbs/CFantasy/search?page="+str(index)+"&q="+quote(search_name)
...
df.to_csv("鬥破蒼穹"+'.csv', encoding='UTF-8',index=False)
